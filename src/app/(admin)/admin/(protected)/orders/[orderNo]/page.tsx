  ...
  return (
    <div className="grid gap-5 xl:grid-cols-[1fr_360px]">
      <section className="space-y-5">
        <div className="rounded-lg border border-neutral-200 bg-white p-4">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              <h1 className="text-xl font-extrabold text-neutral-950">{order.orderNo}</h1>
        ...
        <div className="rounded-lg border border-neutral-200 bg-white p-4">
          <h2 className="text-base font-extrabold">주문 상품</h2>
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          <section className="rounded-lg border border-neutral-200 bg-white p-4">
            <h2 className="text-base font-extrabold">주문자 정보</h2>
          ...
          <section className="rounded-lg border border-neutral-200 bg-white p-4">
            <h2 className="text-base font-extrabold">배송지 정보</h2>
            <dl className="mt-3 space-y-2 text-sm">
              <div className="flex justify-between gap-3">
        ...
        <div className="rounded-lg border border-neutral-200 bg-white p-4">
          <h2 className="text-base font-extrabold">상태 이력</h2>
            ...
            {order.history.length === 0 ? (
              ...
              order.history.map((history) => (
                <li key={history.id.toString()} className="text-sm text-neutral-600">
                  {history.fromStatus ? statusLabel(history.fromStatus) : '-'} → {statusLabel(history.toStatus)} /{' '}
      ...
      <aside className="space-y-5">
        <section className="rounded-lg border border-neutral-200 bg-white p-4">
          <h2 className="text-base font-extrabold">결제 금액</h2>
          <dl className="mt-3 space-y-2 text-sm">
        ...
        <section className="rounded-lg border border-neutral-200 bg-white p-4">
          <h2 className="text-base font-extrabold">결제 내역</h2>
        ...
        <section className="rounded-lg border border-neutral-200 bg-white p-4">
          <h2 className="text-base font-extrabold">주문 상태 변경</h2>
        ...
        <section className="rounded-lg border border-neutral-200 bg-white p-4">
          <h2 className="text-base font-extrabold">배송 정보</h2>
          <form action={saveAdminShipment} className="mt-3 space-y-3">
            <input type="hidden" name="orderNo" value={order.orderNo} />
            {shipment ? <input type="hidden" name="shipmentId" value={shipment.id.toString()} /> : null}
            <input
              name="carrier"
