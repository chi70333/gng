// Legacy source: privacy.php, member_article.php
// Cache: ISR 1h. Privacy policy is DB-backed site policy content.
  ...
  return (
    <div className="mx-auto max-w-screen-md px-4 py-8">
      ...
      <section className="mt-6 rounded-lg bg-white p-5">
        <PolicyText content={policy.privacy} htmlEnabled={policy.htmlEnabled} />
      </section>
    </div>
  );
}
